...
%     *****************************************************************
   ...
   fprintf(1,'deltaOdotoa %11.7f  %11.7f \n',deltaOdotoa, deltaOdotoa*re/tusec);
...
%
   ...
   fprintf(1,'dadt %11.7f  %11.7f \n',dadt*anomper, dadt);
   fprintf(1,'didt %11.7f  %11.7f \n',didt*anomper*180/pi, didt);
        
        k2 = 1.0/anomper * (dlpa * dadt + dlpi * didt);
        k1 = sqrt(2.0 * k2 * (-50 - 50) );
   fprintf(1,'k2 %11.7f  %11.7f \n',k2, k2*tusec/re);
   fprintf(1,'k1 %11.7f  %11.7f \n',k1, k1*tusec/re);
   
        da = k1 * anomper / dlpa;
   fprintf(1,'da %11.7f  %11.7f \n',da, da);
        
        tdrift = -k1/k2;
   fprintf(1,'tdrift %11.7f sec  %11.7f min \n',tdrift, tdrift/60.0);
        deltav = n * 0.5 * da;
